...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&weight=600&size=22&pause=1000&color=00C2FF&center=true&vCenter=true&width=900&height=35&lines=Building+Scalable+AI+%26+Cloud+Systems;Cross-Platform+Mobile+Developer;Real-Time+Architecture+Engineer;Focused+on+Performance+%2B+Security+%2B+Innovation)](https://git.io/typing-svg)
...
<img src="https://skillicons.dev/icons?i=cpp,cs,java,python,javascript,typescript,kotlin,php,swift,rust,react,nextjs,vue,angular,flutter,expo,html,css,tailwind,bootstrap,nodejs,express,django,flask,fastapi,firebase,supabase,mysql,postgres,mongodb,sqlite,aws,gcp,azure,docker,kubernetes,cloudflare,vercel,netlify,tensorflow,pytorch,opencv,figma,blender,photoshop,illustrator,git,github,postman,vscode&perline=14" />
